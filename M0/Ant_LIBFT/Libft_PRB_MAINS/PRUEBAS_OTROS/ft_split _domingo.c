...
/*   Updated: 2025/10/20 09:03:03 by lestrada         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	fill_words(char const *s, char c, int *len_w);
...
char	**ft_split(char const *s, char c)
{
	...
	{
		len_word = 0;
		fill_words(s, c, len_word);
		ft_strlcpy((char *)*result[ind_words], fill_words(s, c, len_word), len_word); 
		ind_words++;
	}
	//result[ind_words] = '\0';
	return(result);
...
int main() {
    ...
    imprimir_matriz_char(mi_matriz, ft_strlen(mi_matriz));
