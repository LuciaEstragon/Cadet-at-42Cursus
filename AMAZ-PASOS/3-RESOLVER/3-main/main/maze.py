...
from generate import elegir_numero, calcular_obligatorios, posibles_movimientos, is_42, generate_42, vecino_aleatorio
                ...
                for i in range(self.height):
                    for j in range(self.width):
                        if self.maze[i][j] in ('·', '*'):
                            ...
                            chose_vec = vecino_aleatorio(i, j, self.maze, self.height, self.width)
                            try:
                                nr, nc = chose_vec
                                print(chose_vec)
                                cola.append((nr, nc))
